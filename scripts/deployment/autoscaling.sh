...
then
    ...
    /home/sgeadmin/ocisge/$CLUSTER_POSTFIX/scripts/add_exec_host 1 >> /home/sgeadmin/ocisge/logs/autoscaling.log
...
then
    ...
    /home/sgeadmin/ocisge/$CLUSTER_POSTFIX/scripts/remove_exec_host >> /home/sgeadmin/ocisge/logs/autoscaling.log
fi
